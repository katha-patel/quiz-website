...
if(isset($_POST['submit']))
{
  ...
  $con = mysqli_connect('localhost','root','','quiz');
  $query="INSERT INTO `info`(`quizid1`,`title`, `name`, `timein`, `timeout`, `discription`) VALUES ('$unique','$title','$name','$timein','$timeout','$discription')";
...
for($i=0;$i<3;$i++)
{
    ...
    $con = mysqli_connect('localhost','root','','quiz');
    $query="INSERT INTO `quizoid`( `quizid`,`question`, `option1`, `option2`, `option3`, `option4`, `answer`) VALUES ('$unique','$question','$option1','$option2','$option3','$option4','$answer') " ;
